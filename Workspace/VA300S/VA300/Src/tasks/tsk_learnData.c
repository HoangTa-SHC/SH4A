...
static int TC_RING_FUNC(void)
{
    ...
    while(TRUE)
    {
		...
		else if(g_numberOfLearnData == B3S1F0)
		{
			...
			DBG_PRINT1("[TC_RING_02] Check remove all data: %d", ret);
		...
		else if(g_numberOfLearnData == (FULL_ALL_BANK+B3S0F0))
		{
			...
			DBG_PRINT1("[TC_RING_05] Check remove all data: %d", ret);
		...
		////////////////////////////////////////////////////////////
		/* add Unique data */
		if(g_numberOfLearnData == B3S3F2 || g_numberOfLearnData == B3S3F4)
		{
...
static int TC_NOTIFY_FUNC(void)
{
    ...
    while(TRUE)
    {
		...
		g_numberOfLearnData++;
		if(g_numberOfLearnData == (FULL_ALL_BANK+B3S2F0))
		{
			...
			DBG_PRINT1("[TC_UNIQUE_ADD_02] Check remove all data: %d", ret);
			/* Check data */
			ret = lcheck_notify_data(2);
			DBG_PRINT1("[TC_UNIQUE_ADD_02] Check notify data: %d", ret);
		}
		else if(g_numberOfLearnData == (FULL_ALL_BANK+B3S4F0))
		{
			...
			DBG_PRINT1("[TC_UNIQUE_ADD_19] Check remove all data: %d", ret);
			/* Check data */
			ret = lcheck_notify_data(19);
			DBG_PRINT1("[TC_UNIQUE_ADD_19] Check notify data: %d", ret);
		}
		else if(g_numberOfLearnData == (FULL_ALL_BANK+B3S7F0))
		{
			...
			DBG_PRINT1("[TC_UNIQUE_ADD_01] Check remove all data: %d", ret);
			/* Check data */
